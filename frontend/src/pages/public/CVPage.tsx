...
import { Section, SectionHeading, Spinner, EmptyState, Button } from '@/components/ui'
        ...
        <div className="flex flex-col items-center justify-center py-32 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-ink-400 text-sm">
              Le CV sera mis en ligne très prochainement.
            </p>
          </div>
        </div>
      )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-ink-400 font-mono">
                  Mis à jour le {new Date(cv.upload_date).toLocaleDateString('fr-FR')}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-center gap-4 mb-4">
                <button
                  ...
                  className="p-2 rounded-lg glass glass-hover disabled:opacity-30
                             text-ink-300 hover:text-white transition-all"
                >
